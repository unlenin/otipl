# Django settings for otipl project.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_DIR, 'otipl/otipl.db'),                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = os.path.join(PROJECT_DIR, "static_storage")
...
SECRET_KEY = '=l%et)fkm2=h@nbm1l=me=qd=wtl7hp+a2=6fge2iw+u%u_k0z'
...
ROOT_URLCONF = 'otipl.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'otipl.wsgi.application'
