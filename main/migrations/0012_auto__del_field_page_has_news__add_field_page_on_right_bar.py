...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Page.has_news'
        db.delete_column(u'main_page', 'has_news')

        # Adding field 'Page.on_right_bar'
        db.add_column(u'main_page', 'on_right_bar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Page.has_news'
        db.add_column(u'main_page', 'has_news',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Page.on_right_bar'
        db.delete_column(u'main_page', 'on_right_bar')
    ...
    models = {
        ...
        u'main.page': {
            ...
            'on_right_bar': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
