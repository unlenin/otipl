...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'main_page', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1383086246086871, unique=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.order'
        db.delete_column(u'main_page', 'order')
