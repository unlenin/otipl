...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.get_pass_button'
        db.add_column(u'main_page', 'get_pass_button',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.get_pass_button'
        db.delete_column(u'main_page', 'get_pass_button')
